...
export default function TransaccionesPage() {
  ...
  return (
    <div className="p-4 md:p-6 space-y-4 dark:bg-slate-900 min-h-screen">
      {/* Header */}
      ...
      {/* Filters */}
      <div className="bg-white dark:bg-slate-800 rounded-xl p-4 flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="w-full sm:w-auto px-3 py-2.5 bg-slate-100 dark:bg-slate-700 rounded-lg text-sm text-slate-600 dark:text-slate-200 outline-none cursor-pointer"
        >

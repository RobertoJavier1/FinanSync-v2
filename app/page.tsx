    ...
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm p-8 w-full max-w-md">
        ...
        <div className="flex items-center my-4">
          ...
          <span className="px-3 text-slate-400 text-xs">o</span>
          <div className="flex-1 border-t border-slate-200 dark:border-slate-600" />
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full border border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 text-slate-700 dark:text-slate-200 font-semibold py-3 rounded-lg transition-colors text-sm flex items-center justify-center gap-2"
        >
        ...
        <p className="text-center mt-4 text-slate-500 text-sm">
          ...
          <Link href="/registrarse" className="text-blue-600 font-semibold hover:underline">
            Regístrate aquí
          </Link>
        </p>
      </div>
